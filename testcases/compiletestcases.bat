...
gcc SGD_MBGD_with_DataProvider.c  -I ../include -I ../include/error -I ../include/vector -I ../include/matrix  -I ../private/include -I ../private/include/error -I ../include/math -I ../include/ml_math -L ../lib -lsss -o SGD_MBGD_with_DataProvider.out -Wall
